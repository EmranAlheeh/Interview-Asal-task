...
def test_delete_user_with_new_attribute_data():
    newAttributesValueFile = 'C:/Users/misol/PycharmProjects/pythonProject/venv/TestData/newAttributesValue.json'
    response = requests.delete(url, json=read_json_file_data(newAttributesValueFile))
    assert response.status_code == 201